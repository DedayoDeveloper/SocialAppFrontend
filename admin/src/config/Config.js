...
export const ApiEndpoints = {
    ...
    USER_LOGIN: 'admin/authenticate',
    GET_ESCORTS: 'getallescort',
    DELETE_ESCORT:  id =>  `delete/escort/${id}`,
    UPDATE_PAYMENT_STATUS: userId => `update/registration/payment/${userId}`,
    CREATE_ESCORTS: 'createescort',
    FETCH_CATEGORIES: 'getcategory/price',
    FETCH_STATES: 'list/states',
